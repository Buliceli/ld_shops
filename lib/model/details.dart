...
//    errorMsg = json['errorMsg'];
    data = json['data'] != null ? new DeatilsGoodsData.fromJson(json['data']) : null;
//    page = json['page'];
//    limit = json['limit'];
  }
...
class DeatilsGoodsData {
  GoodInfo goodInfo;
  List<GoodComments> goodComments;
  AdvertesPicture advertesPicture;

  DeatilsGoodsData({this.goodInfo, this.goodComments, this.advertesPicture});

  DeatilsGoodsData.fromJson(Map<String, dynamic> json) {
